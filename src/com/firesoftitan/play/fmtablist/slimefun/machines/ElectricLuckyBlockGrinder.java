...
public abstract class ElectricLuckyBlockGrinder extends AContainer {
    ...
    private void makeBlock(Block b, int slot, int amount, int OutAmount) {
        ...
        if (SlimefunStartup.chance(100, 25)) adding.setAmount(adding.getAmount() + 1);
        if (SlimefunStartup.chance(100, 15)) adding.setAmount(adding.getAmount() + 1);
        if (SlimefunStartup.chance(100, 5)) adding.setAmount(adding.getAmount() + 1);
