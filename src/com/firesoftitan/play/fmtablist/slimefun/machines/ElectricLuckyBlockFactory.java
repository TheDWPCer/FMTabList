...
public abstract class ElectricLuckyBlockFactory extends AContainer {
    ...
    protected void tick(Block b) {
        if (isProcessing(b)) {
            ...
            for (int slot: getInputSlots()) {
                ...
                check = SlimefunItems.GOLD_4K.clone();
                amount = 28;
                ...
                check = SlimefunItems.GOLD_6K.clone();
                amount = 24;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_8K.clone();
                amount = 20;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_10K.clone();
                amount = 16;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_12K.clone();
                amount = 12;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_14K.clone();
                amount = 11;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_16K.clone();
                amount = 10;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_18K.clone();
                amount = 9;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_20K.clone();
                amount = 8;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_22K.clone();
                amount = 7;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_24K.clone();
                amount = 6;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
                ...
                check = SlimefunItems.GOLD_24K_BLOCK.clone();
                amount = 1;
                check.setAmount(amount);
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), check, true)) {
                    makeBlock(b, slot, amount);
    ...
    private void makeBlock(Block b, int slot, int amount) {
        ItemStack adding = SFItems.LuckyBlock;
