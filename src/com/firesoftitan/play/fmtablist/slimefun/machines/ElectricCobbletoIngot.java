...
public abstract class ElectricCobbletoIngot extends AContainer {
    ...
    public String getInventoryTitle() {
        return "&bElectric Cobble to Ingot";
    }
        ...
        if (isProcessing(b)) {
            ...
            for (int slot: getInputSlots()) {
                if (SlimefunManager.isItemSimiliar(BlockStorage.getInventory(b).getItemInSlot(slot), new ItemStack(Material.COBBLESTONE, 8), true)) {
                    ...
                    ItemStack adding = new ItemStack(Material.IRON_INGOT, 1);
                    if (SlimefunStartup.chance(100, 25)) adding = SlimefunItems.GOLD_4K;
                    else if (SlimefunStartup.chance(100, 25)) adding = SlimefunItems.ALUMINUM_INGOT;
                    else if (SlimefunStartup.chance(100, 25)) adding = SlimefunItems.COPPER_INGOT;
                    else if (SlimefunStartup.chance(100, 25)) adding = SlimefunItems.ZINC_INGOT;
                    else if (SlimefunStartup.chance(100, 25)) adding = SlimefunItems.TIN_INGOT;
    ...
    public String getMachineIdentifier() {
        return "ELECTRIC_COBBLE_TO_INGOT";
    }
